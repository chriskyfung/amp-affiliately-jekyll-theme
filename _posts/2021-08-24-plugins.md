...
{% include alert.html type="info" content="**NOTE**: Jekyll Archives is not a GitHub Pages' [whitelisted plugins](https://pages.github.com/versions/)." %}
...
{% include alert.html type="info" content="**NOTE**: Jekyll Loading Lazy is not a GitHub Pages' [whitelisted plugins](https://pages.github.com/versions/)." %}
...
{% include alert.html type="info" content="**NOTE**: Jekyll Minifier is not a GitHub Pages' [whitelisted plugins](https://pages.github.com/versions/)." %}
...
{% include alert.html type="info" content="**NOTE**: Jekyll Scholar is not a GitHub Pages' [whitelisted plugins](https://pages.github.com/versions/)." %}
